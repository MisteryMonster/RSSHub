...
router.get('/github/discussions/:user/:repo/:discussions', require('./routes/github/discussions'));
// f-droid
...
// 珠海疫情相关
router.get('/gov/zhuhai/yqxx', require('./routes/gov/zhuhai/yqxx'));
router.get('/gov/zhuhai/yqfkzt', require('./routes/gov/zhuhai/yqfkzt'));
